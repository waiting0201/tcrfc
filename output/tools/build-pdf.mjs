...
const DOCS = {
  ...
  'bw-zh': {
    md: 'TCRFC_台中藍鯨官網功能規劃書.md',
    pdf: 'TCRFC_台中藍鯨官網功能規劃書.pdf',
    lang: 'zh-Hant',
    // 內容主體是藍鯨，收款與系統主體仍是俱樂部，封面署名採藍鯨
    club: '台中藍鯨女子足球隊',
    title: ['官方網站', '功能規劃書'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.　在地扎根 · 放眼世界',
    labels: { version: '文件版本', date: '建立日期' },
    runningHead: (v) => `台中藍鯨官網功能規劃書 ${v}`,
    runningFoot: '台中藍鯨 Taichung Blue Whale',
    font: '"PingFang TC","Noto Sans TC","Hiragino Sans","Helvetica Neue",Arial,sans-serif',
  },
  'bw-en': {
    md: 'TCRFC_Taichung_Blue_Whale_Website_Specification_EN.md',
    pdf: 'TCRFC_Taichung_Blue_Whale_Website_Specification_EN.pdf',
    lang: 'en',
    club: 'Taichung Blue Whale',
    title: ['Official Website', 'Functional Specification'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.',
    labels: { version: 'Document version', date: 'Date' },
    runningHead: (v) => `Taichung Blue Whale Website Specification ${v}`,
    runningFoot: 'Taichung Blue Whale',
    font: '"Helvetica Neue",Helvetica,Arial,"PingFang TC","Noto Sans TC",sans-serif',
  },
  'app-en': {
  ...
  // ── 客戶版功能說明：純文字摘要，不談技術、不列排程與待決事項 ──────────
  'brief-zh': {
    md: 'TCRFC_官網功能說明_客戶版.md',
    pdf: 'TCRFC_官網功能說明_客戶版.pdf',
    lang: 'zh-Hant',
    club: '台中磐石足球俱樂部',
    title: ['官方網站', '功能說明（客戶版）'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.　在地扎根 · 放眼世界',
    labels: { version: '文件版本', date: '建立日期' },
    runningHead: (v) => `TCRFC 官網功能說明（客戶版）${v}`,
    runningFoot: '台中磐石足球俱樂部 TCRFC',
    font: '"PingFang TC","Noto Sans TC","Hiragino Sans","Helvetica Neue",Arial,sans-serif',
  },
  'brief-en': {
    md: 'TCRFC_Website_Feature_Overview_EN.md',
    pdf: 'TCRFC_Website_Feature_Overview_EN.pdf',
    lang: 'en',
    club: 'Taichung Rock FC',
    title: ['Official Website', 'Feature Overview'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.',
    labels: { version: 'Document version', date: 'Date' },
    runningHead: (v) => `TCRFC Website Feature Overview ${v}`,
    runningFoot: 'Taichung Rock FC — TCRFC',
    font: '"Helvetica Neue",Helvetica,Arial,"PingFang TC","Noto Sans TC",sans-serif',
  },
  'bw-brief-zh': {
    md: 'TCRFC_台中藍鯨官網功能說明_客戶版.md',
    pdf: 'TCRFC_台中藍鯨官網功能說明_客戶版.pdf',
    lang: 'zh-Hant',
    club: '台中藍鯨女子足球隊',
    title: ['官方網站', '功能說明（客戶版）'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.　在地扎根 · 放眼世界',
    labels: { version: '文件版本', date: '建立日期' },
    runningHead: (v) => `台中藍鯨官網功能說明（客戶版）${v}`,
    runningFoot: '台中藍鯨 Taichung Blue Whale',
    font: '"PingFang TC","Noto Sans TC","Hiragino Sans","Helvetica Neue",Arial,sans-serif',
  },
  'bw-brief-en': {
    md: 'TCRFC_Taichung_Blue_Whale_Website_Feature_Overview_EN.md',
    pdf: 'TCRFC_Taichung_Blue_Whale_Website_Feature_Overview_EN.pdf',
    lang: 'en',
    club: 'Taichung Blue Whale',
    title: ['Official Website', 'Feature Overview'],
    promise: 'LOCAL ROOTS. GLOBAL PATHWAYS.',
    labels: { version: 'Document version', date: 'Date' },
    runningHead: (v) => `Taichung Blue Whale Website Feature Overview ${v}`,
    runningFoot: 'Taichung Blue Whale',
    font: '"Helvetica Neue",Helvetica,Arial,"PingFang TC","Noto Sans TC",sans-serif',
  },
};
