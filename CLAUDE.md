...
> [`output/TCRFC_慈善捐款平台功能規劃書.md`](output/TCRFC_慈善捐款平台功能規劃書.md)（v1.3，709 行，獨立網域的掃碼捐款平台）。
...
| 慈善捐款平台 | 📄 **規格已完成**（獨立規劃書 v1.3，中英雙版）。獨立網域、共用主站後台與資料庫、串接 LINE Pay 與電子發票。**尚未開發；網域與勸募資格未定** |
