...
<template>
  <div class="placeholder-view">
    <div class="placeholder-view__header">
      <h1 class="placeholder-view__title">{{ label }}</h1>
      <FrontendUnitBanner v-if="code" :module-code="code" />
    </div>
    <el-empty description="這個模組還沒有做，之後會補上">
      <template #image>
        <el-icon :size="64" color="var(--el-text-color-placeholder)"><Tools /></el-icon>
      </template>
