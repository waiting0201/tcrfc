...
useSeoMeta({
  ...
  description:
    '台中磐石足球俱樂部官方商店：主場球衣與厚底緩震機能襪。以 LINE Pay 付款、自動開立電子發票，可宅配、超商取貨或現場自取。',
})
</script>
...
<section class="band band--tight" aria-labelledby="filters-title">
  <div class="container">
    ...
    <div class="filter-row">
      <div class="filter-field">
        ...
        <select id="f-collection">
          ...
          <option value="academy">學院商品 Academy</option>
    ...
    <p class="result-count">共 2 件商品</p>
  </div>
</section>
...
<section class="band band--tight" aria-labelledby="products-title">
  <div class="container">
    ...
    <div class="editorial-note" style="margin-top:2.5rem">
      <p><strong>學院商品 Academy Collection</strong> 與 <strong>球迷商品 Fan Collection</strong> 尚在開發，首波商品確定後於此上架。</p>
