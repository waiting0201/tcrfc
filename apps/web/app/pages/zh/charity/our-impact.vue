...
<section class="band grain grain--2 stats-band" aria-labelledby="impact-stats-title">
  ...
  <div class="band-inner container">
    ...
    <div class="stats-grid" style="margin-top:2rem;">
      <div class="stat">
        <p class="stat__num" aria-label="尚未公開">—</p>
        <p class="stat__label">合作公益團體數</p>
      </div>
      <div class="stat">
        <p class="stat__num" aria-label="尚未公開">—</p>
        <p class="stat__label">累計捐助項次</p>
      </div>
      <div class="stat">
        <p class="stat__num" aria-label="尚未公開">—</p>
        <p class="stat__label">服務地區數</p>
      </div>
      <div class="stat">
        <p class="stat__num">3</p>
        <p class="stat__label">已公開紀錄的慈善事蹟</p>
      </div>
    </div>
...
<section class="band sponsor-band" aria-labelledby="impact-partners-title">
  <div class="band-inner container">
    ...
    <ul class="partner-list">
      <li class="partner-list__item">潭秀非營利幼兒園</li>
      <li class="partner-list__item">台中磐石盃少年足球隊伍</li>
      <li class="partner-list__item">潭秀國中暨嶺東高中聯隊</li>
    </ul>
