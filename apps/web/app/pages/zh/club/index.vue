...
<section class="page-hero page-hero--media">
  ...
  <div class="container">
    ...
    <p class="page-hero__lede">從西屯足球場出發的一線隊，是台中磐石所有青訓體系最終要銜接的舞台。這裡整理球隊陣容、球員發展系統、加入管道，以及選手通往海外的路徑。</p>
  </div>
</section>
...
<section class="band grain grain--2 stats-band" aria-labelledby="club-stats-title">
  ...
  <div class="band-inner container">
    <div class="stats-grid">
      <div class="stat">
        <p class="stat__num">2024</p>
        <p class="stat__label">創立年份</p>
      </div>
      <div class="stat">
        <p class="stat__num"><span>2024</span></p>
        <p class="stat__label">全國乙級聯賽冠軍</p>
      </div>
      <div class="stat">
