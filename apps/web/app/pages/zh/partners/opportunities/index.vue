...
// app/pages/zh/partners/opportunities/index.vue — 由 site/src/pages/zh/partners/opportunities/index.html 轉來
...
<section class="band" id="deck-download" aria-labelledby="deck-download-title">
  <div class="container">
    <div class="eyebrow-row">
      ...
      <p class="section-lede">留下公司與聯絡資訊，我們將提供完整贊助提案簡介 PDF 下載連結。</p>
    </div>

    <form class="form-grid" onsubmit="return false;" style="margin-top:1.75rem;max-width:760px">
      <div class="form-field">
        <label for="deck-company">公司名稱</label>
        <input type="text" id="deck-company" name="company" autocomplete="organization" required>
      </div>
      <div class="form-field">
        <label for="deck-name">聯絡人姓名</label>
        <input type="text" id="deck-name" name="name" autocomplete="name" required>
      </div>
      <div class="form-field form-field--full">
        <label for="deck-email">Email</label>
        <input type="email" id="deck-email" name="email" autocomplete="email" required>
      </div>
      <div class="form-field form-field--full">
        <button class="btn btn--primary" type="submit" disabled>取得下載連結</button>
      </div>
    </form>
  </div>
</section>
