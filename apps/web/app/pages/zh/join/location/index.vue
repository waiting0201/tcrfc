...
<section class="page-hero">
  ...
  <div class="container">
    ...
    <p class="page-hero__lede">台中磐石的訓練基地、主場與學院場地分布於台中北屯一帶，以下整理各場地的位置、地圖與交通指引。</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="eyebrow-row">
      <div>
        ...
        <h2 class="section-title" id="venues-title">訓練基地・主場・學院場地</h2>
      </div>
    </div>
    ...
    <div class="grid grid--3">
      ...
      <article class="venue-card">
        ...
        <h3 class="venue-card__name">西屯足球場<span class="en">Xitun Football Field</span></h3>
        <p class="venue-card__addr">台中市北屯區崇平路二段景谷巷 11 弄 41 號</p>
      </article>
  ...
  <div class="container">
    ...
    <div class="grid grid--3">
      ...
      <div class="direction-card">
        ...
        <a href="https://www.google.com/maps/search/?api=1&query=%E5%8F%B0%E4%B8%AD%E5%B8%82%E5%8C%97%E5%B1%AF%E5%8D%80%E5%B4%87%E5%B9%B3%E8%B7%AF%E4%BA%8C%E6%AE%B5%E6%99%AF%E8%B0%B7%E5%B7%B711%E5%BC%8441%E8%99%9F" target="_blank" rel="noopener">開啟 Google 導航（西屯足球場）<span class="visually-hidden">（新分頁開啟）</span></a>
      </div>
    </div>
  </div>
</section>
