  ...
  <div class="container">
    ...
    <div class="form-layout form-layout--split">
      <form class="tcrfc-form" action="" method="post" novalidate>
        ...
        <fieldset>
          ...
          <div class="form-grid">
            <div class="form-field">
              ...
              <input type="text" id="md-outlet" name="media_outlet" required autocomplete="organization" aria-describedby="md-outlet-error">
              <p class="field-error" id="md-outlet-error" role="alert">請填寫媒體／機構名稱</p>
            </div>
            <div class="form-field">
              <label for="md-type">採訪類型</label>
              <select id="md-type" name="coverage_type">
        ...
        <fieldset>
          ...
          <div class="form-grid">
            <div class="form-field">
              ...
              <input type="text" id="md-name" name="contact_name" required autocomplete="name" aria-describedby="md-name-error">
            ...
            <div class="form-field">
              ...
              <input type="tel" id="md-phone" name="phone" required autocomplete="tel" aria-describedby="md-phone-error">
            ...
            <div class="form-field">
              ...
              <input type="email" id="md-email" name="email" required autocomplete="email" aria-describedby="md-email-error">
        ...
        <fieldset>
          ...
          <div class="form-grid">
            <div class="form-field form-field--full">
              ...
              <textarea id="md-topic" name="topic" required aria-describedby="md-topic-hint md-topic-error"></textarea>
            ...
            <div class="form-field">
              ...
              <input type="date" id="md-deadline" name="deadline" required aria-describedby="md-deadline-error">
        ...
        <button class="btn btn--primary btn--block" type="submit">送出詢問</button>
