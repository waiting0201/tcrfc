...
<nav class="breadcrumb" aria-label="麵包屑">
  <div class="container">
    <ol>
      ...
      <li aria-current="page">學院生活</li>
    </ol>
  </div>
</nav>

<section class="page-hero page-hero--media">
  <img class="page-hero__bg" src="/assets/img/academy/life-07.jpg" alt="" width="1600" height="900">
  <div class="container">
    <p class="page-hero__eyebrow">4.6 Academy Life</p>
    <h1>學院生活<span class="en">Academy Life</span></h1>
    <p class="page-hero__lede">
      訓練日常、比賽現場與隊上活動——用影像記錄台中磐石學院學員每一次奔跑與突破的瞬間。
    </p>
  </div>
</section>
...
<section class="band">
  <div class="container">
    <div class="eyebrow-row">
      ...
      <p class="section-lede">下列照片皆為學員未成年，說明僅描述訓練場景，不標示個人姓名。</p>
    </div>
